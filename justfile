...
pipeline-start ID:
    RUST_LOG=info cargo run --release --bin bubbaloop pipeline start -i {{ID}}

pipeline-stop ID:
    RUST_LOG=info cargo run --release --bin bubbaloop pipeline stop -i {{ID}}

pipeline-list:
    RUST_LOG=info cargo run --release --bin bubbaloop pipeline list
